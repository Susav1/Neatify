...
//   const handleSwitchToCleaner = () => {
//     if (authState.user?.role === 'Cleaner' && authState.user.cleanerStatus === 'APPROVED') {
//       router.push('/cleaner/Home');
//     } else if (authState.user?.cleanerStatus === 'PENDING') {
//       Alert.alert('Application Pending', 'Your cleaner application is under review.');
//     } else if (authState.user?.cleanerStatus === 'REJECTED') {
//       Alert.alert(
//         'Application Rejected',
//         'Your cleaner application was rejected. You can reapply.',
//         [
//           { text: 'Cancel', style: 'cancel' },
//           { text: 'Reapply', onPress: () => router.push('/(auth)/document-verification') },
//         ]
//       );
//     } else {
...
//         <TouchableOpacity style={styles.optionCard} onPress={() => setCurrentPage('Bookings')}>
...
//         <TouchableOpacity style={styles.optionCard} onPress={() => setCurrentPage('Messages')}>
//           <View style={styles.optionContent}>
...
//         <TouchableOpacity style={styles.optionCard} onPress={handleSwitchToCleaner}>
//           <View style={styles.optionContent}>
//             <Icon name="cleaning-services" size={24} color="#9C27B0" />
//             <Text style={styles.optionText}>
//               {authState.user?.role === 'Cleaner' && authState.user.cleanerStatus === 'APPROVED'
//                 ? 'Switch to Cleaner Dashboard'
//                 : authState.user?.cleanerStatus === 'PENDING'
//                 ? 'Cleaner Application Pending'
//                 : authState.user?.cleanerStatus === 'REJECTED'
//                 ? 'Reapply as Cleaner'
//                 : 'Apply as Cleaner'}
//             </Text>
//           </View>
