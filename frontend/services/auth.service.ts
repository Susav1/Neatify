...
//     const response = await api.post('/register', { ...data, role: 'User' });
...
// export const applyAsCleaner = async (data: {
//   userId: string;
//   phone: string;
//   nationalId: string;
// }) => {
//   try {
//     console.log('[auth.service] Applying as cleaner with data:', data);
//     const response = await api.post('/api/cleaner/apply', data);
//     console.log('[auth.service] Cleaner application response:', response.data);
//     return response.data;
//   } catch (error: any) {
//     console.error(
//       '[auth.service] Cleaner application error:',
